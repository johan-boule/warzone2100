...
macro(_hOutput _outputFile _quiet)
	...
	string(CONCAT _hContents ${_hContents} "#define VCS_TAG_NET			\"${VCS_TAG_NET}\"\n")
...
macro(_shOutput _outputFile _quiet)
	...
	string(CONCAT _hContents ${_hContents} "VCS_TAG_NET=\"${VCS_TAG_NET}\"\n")
...
if(true)
	...
	set(VCS_TAG 4.7.0-jb6)
	set(VCS_MOST_RECENT_TAGGED_VERSION 4.7.0-jb6)
	set(VCS_EXTRA 4.7.0-jb6)
	...
	set(VCS_SHORT_HASH 7d3d8e5)
	set(VCS_MOST_RECENT_COMMIT_YEAR 2026)
	set(VCS_MOST_RECENT_COMMIT_DATE 2026-04-07)
	set(VCS_COMMIT_COUNT 0)
	set(VCS_COMMIT_COUNT_ON_MASTER_UNTIL_BRANCH 0)
	set(VCS_BRANCH_COMMIT_COUNT 0)
