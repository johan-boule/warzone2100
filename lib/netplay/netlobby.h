...
{
	HostJoinOptionValue botProt = HostJoinOptionValue::Allow;
	HostJoinOptionValue proxyIPs = HostJoinOptionValue::Allow;
	HostJoinOptionValue hostingIPs = HostJoinOptionValue::Allow;
};
